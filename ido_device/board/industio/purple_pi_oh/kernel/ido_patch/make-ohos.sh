...
export PRODUCT_PATH=vendor/industio/purple_pi_oh
...
ID_CONF=6
model_list=(
	"IDO-PurPle-Pi-OH-HDMI  arm64 0xfe660000 tspi-rk3566-user-v10-linux Image rockchip_linux_defconfig"
	"IDO-PurPle-Pi-OH-MIPI  arm64 0xfe660000 ido-pi-oh3566-mipi-v1 Image rockchip_linux_defconfig"
)
