...
function copy_and_patch_kernel_source()
{
    ...
    #industio patch
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/dts/* ${KERNEL_SRC_TMP_PATH}/arch/arm64/boot/dts/rockchip/
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/media/i2c/* ${KERNEL_SRC_TMP_PATH}/drivers/media/i2c/
    rm -rf ${KERNEL_SRC_TMP_PATH}/drivers/net/wireless/rockchip_wlan/rkwifi/bcmdhd_wifi6/
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/wifi/bcmdhd_wifi6 ${KERNEL_SRC_TMP_PATH}/drivers/net/wireless/rockchip_wlan/rkwifi/
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/touchscreen/* ${KERNEL_SRC_TMP_PATH}/drivers/input/touchscreen/
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/make-boot.sh ${KERNEL_SRC_TMP_PATH}/
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/make-ohos.sh ${KERNEL_SRC_TMP_PATH}/
    ...
    ##industio rockchip_linux_defconfig patch
   cp -rf ${BUILD_SCRIPT_PATH}/kernel/ido_patch/rockchip_linux_defconfig ${KERNEL_SRC_TMP_PATH}/arch/arm64/configs/rockchip_linux_defconfig
